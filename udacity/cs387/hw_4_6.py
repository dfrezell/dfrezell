...
c2 = bits_to_int(string_to_bits(cipher2))
m2 = ''#YOUR ANSWER HERE
################
...
c3 = bits_to_int(string_to_bits(cipher3))
m3 = ''#YOUR ANSWER HERE
################
...
c4 = bits_to_int(string_to_bits(cipher4))
m4 = ''#YOUR ANSWER HERE
################
...
c5 = bits_to_int(string_to_bits(cipher5))
m5 = ''#YOUR ANSWER HERE
################
...
c6 = bits_to_int(string_to_bits(cipher6))
m6 = ''#YOUR ANSWER HERE
################
...
c7 = bits_to_int(string_to_bits(cipher7))
m7 = ''#YOUR ANSWER HERE
################
...
c8 = bits_to_int(string_to_bits(cipher8))
m8 = ''#YOUR ANSWER HERE
################
...
c9 = bits_to_int(string_to_bits(cipher9))
...
c10 = bits_to_int(string_to_bits(cipher10))
...
c11 = bits_to_int(string_to_bits(cipher11))
m11 = ''#YOUR ANSWER HERE
d11 = 
################
...
c12 = bits_to_int(string_to_bits(cipher12))
m12 = ''#YOUR ANSWER HERE
d12 = 
################
...
c13 = bits_to_int(string_to_bits(cipher13))
...
c14 = bits_to_int(string_to_bits(cipher14))
...
c15 = bits_to_int(string_to_bits(cipher15))
m15 = ''#YOUR ANSWER HERE
################


'''
# (1) Low-Exponent-Attack  Video 4-22
# (2) Common-Modulus-Attack: double encryption of m with 2 different public
#     keys (n, e), (n, f), gcdf(e, f) = 1
# (3) Cycling-Attack  there exists a natural k satisfying m=c^(e^(k-1)) (mod n)
#     hence decryption is possible using  (m,e) or (m,d).  The same holds for encryption.
# (4) Wiener's-Attack
# (5) Multiplication-Attack E(e,n)(m1)*E(e,n)(m2)=E(e,n)(m1*m2)
# (6) Greates Common Divisor Attack: if n_i and n_j share a common factor q,
#     the gcd(n_i, n_j) can be computed quickly
'''
...
#            q = n_i / p
#            tot = (p - 1) * (q - 1)
#            (d, x1, x2) = eea(ee[i], tot)
#            print i, d
#    print

# solved both 11 and 12, but we can't decode the message...we just have
# the right key.
#im = pow(c11, d11, n11)
#ic = pow(im, e11, n11)
#print ic == c11
