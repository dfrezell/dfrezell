...
def rabbits_fast(n, LUT):
    ...
    if n == 1:
        ...
        LUT[n] = rabbits_fast(n-1, LUT) + rabbits_fast(n-2, LUT)
        return LUT[n]
    else:
        LUT[n] = rabbits_fast(n-1, LUT) + rabbits_fast(n-2, LUT) - rabbits_fast(n-5, LUT)
        return LUT[n]

def rabbits(n):
    LUT = {}
    return rabbits_fast(n, LUT)
